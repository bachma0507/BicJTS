...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.store = [[StoreViewController alloc] initWithNibName:nil bundle:nil];
...
//    }
    ...
    splashView = [[UIImageView alloc] initWithFrame:CGRectMake(0,0,_window.frame.size.width,_window.frame.size.height)];
